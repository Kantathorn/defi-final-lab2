...
describe("Liquidation", function () {
  it("Test Liquidation for 2,000 USDT", async function () {
    console.log("\n-----Liquidation for 2,000 USDT-----")
    ...
    console.log("-----End of Liquidation for 2,000 USDT-----")
  });
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  it("Test Liquidation for 5,000 USDT", async function () {
    console.log("\n-----Liquidation for 5,000 USDT-----")
    await network.provider.request({
        method: "hardhat_reset",
        params: [{
          forking: {
    ...
    expect(profit.gt(BigNumber.from(0)), "not profitable").to.be.true;
    //writeFile('profit.txt', String(utils.formatEther(profit)), function (err) {console.log("failed to write profit.txt: %s", err)});
    console.log("-----End of Liquidation for 5,000 USDT-----")
  });
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  it("Test Liquidation for 10,000 USDT", async function () {
    console.log("\n-----Liquidation for 10,000 USDT-----")
    await network.provider.request({
        method: "hardhat_reset",
        params: [{
          forking: {
    ...
    expect(profit.gt(BigNumber.from(0)), "not profitable").to.be.true;
    //writeFile('profit.txt', String(utils.formatEther(profit)), function (err) {console.log("failed to write profit.txt: %s", err)});
    console.log("-----End of Liquidation for 10,000 USDT-----")
  });
});